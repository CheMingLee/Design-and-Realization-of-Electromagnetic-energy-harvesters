...
for i, amp in enumerate(amp_list):
    ...
    plt.savefig('./ch6-2-2/amp/{0}mm_Exp_F_X.png'.format(amp), bbox_inches='tight')

    plt.figure(i+10)
    plt.legend(loc=1, fontsize=14)
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.savefig('./ch6-2-2/amp/{0}mm_Sim_F_X.png'.format(amp), bbox_inches='tight')
...
for i, feq in enumerate(feq_list):
    ...
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.savefig('./ch6-2-2/feq/{0}hz_Exp_F_X.png'.format(feq), bbox_inches='tight')

    plt.figure(i+30)
    plt.legend(loc=1, fontsize=14)
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.savefig('./ch6-2-2/feq/{0}hz_Sim_F_X.png'.format(feq), bbox_inches='tight')
