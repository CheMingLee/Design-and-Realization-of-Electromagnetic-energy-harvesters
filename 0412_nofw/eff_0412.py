...
for feq in feq_list:
    ...
    plt.title('{0}Hz'.format(feq), fontsize=14)
    plt.xlabel(r'External electrical load ($\Omega$)', fontsize=14)
    plt.ylabel('Mechanical Efficiency', fontsize=14)
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.xlim([6.8, 30])
    plt.legend(loc=1, fontsize=14)
    plt.grid()
    plt.savefig('./fig/efficiency/eff_{0}hz.png'.format(feq), bbox_inches='tight')
...
for amp in amp_list:
    ...
    plt.title('{0}mm'.format(amp), fontsize=14)
    plt.xlabel('Excitation frequency (Hz)', fontsize=14)
    plt.ylabel('Mechanical Efficiency', fontsize=14)
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.xlim([1, 3])
    ...
    plt.legend(loc=1, fontsize=14)
    plt.grid()
    plt.savefig('./fig/efficiency/eff_{0}mm.png'.format(amp), bbox_inches='tight')
